			...
			<ul className="grid grid-cols-2 gap-6 md:grid-cols-4">
				{skills.map(({ name, logo }) => (
					<li key={name} className="group">
						<div className="flex h-full flex-col items-center justify-center gap-4 rounded-2xl border border-white/10 bg-linear-to-br from-black/50 to-dark p-8 shadow-lg transition-all duration-500 hover:border-white/20 hover:shadow-xl hover:shadow-white/5">
